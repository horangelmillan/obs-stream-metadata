...
- **Qué estamos haciendo:** T-030 (P3 parcial): investigación oficial cerrada (F-015/016/017 + `docs/T030-POC.md`); lógica offline en `poc/t030/` con selfcheck 28/28 PASS; pendiente del operador la verificación viva en las 3 plataformas. **No avanzar a P4.**
